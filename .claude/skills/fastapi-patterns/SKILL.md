...
|   |-- router.py             # Central router composition for API and Web routes
|   |-- exceptions.py         # Exceptions app
|   |-- base_dao.py           # Base abstraction for database access
|   |-- base_jinja.py         # Base Jinja configuration and template rendering utilities
|   |-- web/                  # Web UI layer: routes, Jinja templates, static files, and HTMX fragments
|   |-- admin/                # SQLAdmin-based admin panel
|   |-- users/                # fetch users
|   |   `-- models.py         # SQLAlchemy database models
|   |   `-- router.py         # API routes
|   |   `-- web.py            # Web routes HTMX fragments      
|   |   `-- schemas.py        # Pydantic request/response schemas
|   |   `-- dependencies.py   # fetch dependencies
